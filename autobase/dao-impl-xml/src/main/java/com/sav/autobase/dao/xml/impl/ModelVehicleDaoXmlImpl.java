...
@Repository
public class ModelVehicleDaoXmlImpl implements IModelVehicleDao {
	...
	@Override
	public ModelVehicle getById(Integer t) {
		throw new UnsupportedOperationException();
	}

	@Override
	public ModelVehicle insert(ModelVehicle entity) {
		throw new UnsupportedOperationException();
	}

	@Override
	public ModelVehicle update(ModelVehicle entity) {
		throw new UnsupportedOperationException();
	}
