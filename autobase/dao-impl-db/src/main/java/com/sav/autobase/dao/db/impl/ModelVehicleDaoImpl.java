...
import com.sav.autobase.dao.db.mapper.ModelMapper;
...
public class ModelVehicleDaoImpl extends GenericDaoImpl<ModelVehicle> implements IModelVehicleDao {
	...
	final String FIND_MODEL_BY_ID = "SELECT model_vehicle.id as model_id, model_vehicle.brand_id, model_vehicle.name_model, model_vehicle.register_number, model_vehicle.type_id, model_vehicle.count_of_passenger, brand_vehicle.brand_name, type_vehicle.type_name FROM model_vehicle "
